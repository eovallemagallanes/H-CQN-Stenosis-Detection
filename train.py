...
def train_model(device, model, criterion, optimizer, scheduler, num_epochs, batch_size, dataloaders, dataset_sizes, PATH_MODEL, PATH_HISTORY, PATH_TIME, show_plot = False):
    liveloss = PlotLosses()
    ...
    hist_train_time['time'].append(time_elapsed)
    ...
    with open(PATH_TIME, "w") as outfile:  
        json.dump(hist_train_time, outfile)

    return model, hist_train, time_elapsed